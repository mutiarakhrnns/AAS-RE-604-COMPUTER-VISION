...
folder = r"C:\Users\Toshiba\Downloads\RE604\AAS\test"
output_csv = os.path.join(folder, "generate_ground_truth.csv")
...
for file in os.listdir(folder):
    if file.endswith(".txt"):
        ...
        data.append([image_name, plate_number])

# === Simpan ke CSV ===
with open(output_csv, "w", newline="", encoding="utf-8") as csvfile:
    writer = csv.writer(csvfile)  # default delimiter koma
    writer.writerow(["image", "ground_truth"])
    writer.writerows(data)

print(f"✅ File ground truth berhasil disimpan di: {output_csv}")
